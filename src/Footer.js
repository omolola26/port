    ...
    <div className="contain">
      ...
      <div className="contents">
        <div className="left">
          <h1>Get in Touch</h1>
          <p>
            You can get in touch with me on Linkedin and other social media
            platforms.
          </p>
          <div className="icons">
            <div className="row">
            ...
            <div class="row">
              ...
              <div className="info">
                ...
                <div className="sub-title">omololaalimat22@gmail.com</div>
              </div>
            </div>
            <div class="row">
              <i class="fa fa-envelope" aria-hidden="true"></i>
              <div className="info">
                ...
                <div className="sub-title">
                  <a href="https://www.linkedin.com/in/omolola2/">Link</a>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="right">
          <form action="mailto:omololaalimat22@gmail.com">
            ...
            <div className="field">
              <input type="text" placeholder="Subject" required onChange={handleChange} />
            </div>
