...
<div className="port porter">
   ...
   <p>This is a websites where one can book an online gmy instructor, and also one can can book an appiontment with before going to the gmy.</p>
           ...
           <button type="submit"><a href="https://elated-sinoussi-b2073f.netlify.app/"  rel="noreferrer" target="_blank" className="imgIcon">LIVE</a></button>
           <button type="submit" className="life"><a href="https://github.com/omolola26/gmy"  rel="noreferrer" target="_blank"><Code/></a></button>
           </div>
          </div>
